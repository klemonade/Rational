class Rational { 
    ...
    public boolean equals(Object x) {
        ...
        return this.numerator == r.numerator && this.denominator == r.denominator; // TODO: This needs to be modified.
    }
    ...
    public long compareTo(Object x) {
        // to be completed
        Rational r = (Rational) x;
        long totalX = this.numerator * r.denominator;
        long totalR = this.denominator * r.numerator;
        if (totalX > totalR){
            return 1;
        } else if (totalX < totalR){
            return  -1;
        }
